...
<html  lang="en">
	...
	<table border ="0">
		<form action="process/createaccconnect.php" method= "POST"/>
			...
			<tr>
				...
				<label for="home_address">Home Addresss</label><br/>
				<input type= "text" maxlength= "70" name= "cust_location" placeholder= "Enter your location" size= "40" required autofocus />
				</td>
			</tr>
			<tr>
				<td class= "mail">
			...
			<tr>
				...
				<input type ="text" maxlength="10" name= "id_no" placeholder ="Enter your id number"
